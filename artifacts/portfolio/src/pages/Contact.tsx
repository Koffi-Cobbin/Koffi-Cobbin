...
export default function ContactPage() {
  return (
    <div className="mx-auto max-w-3xl px-4 py-8 sm:px-6 sm:py-12 md:py-16 lg:py-20">
      <motion.div
      ...
      >
        ...
        <p className="mt-4 max-w-prose text-base font-medium leading-relaxed text-ink/80 sm:mt-6 sm:text-xl">
