...
// Placeholder content so pages render correctly before the Django/Wagtail
// backend is live. Shapes match Backend.md exactly — swapping lib/api.ts
// over to real fetch calls should require no changes here or in components.
...
export const timeline: TimelineEntry[] = [
  {
    ...
    description: 'Placeholder timeline entry — replace with real bio content.',
    discipline: null,
  },
];
